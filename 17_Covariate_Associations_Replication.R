###################################################
###### COVARIATE ASSOCIATIONS - REPLICATION #######
###################################################
...
rep=as.data.frame(fread("/rhillary/replication_phenotypes_patched/AARSD1_Q9BTE6_OID21311_v1_Oncology.phen"))
prot1=prot1[which(prot1$FID %in% rep$FID),]
...
# ANOVE variables 
anovs=c("Batch","ukb_centre_char","array_char","sample_selection")
...
# Save out file 
fwrite(total,"/rhillary/covariate_assocations_replication.csv",row.names=F)
